...
class KColors {
  static const accentColor = Color(0xFFFF0000); // Deep Red
  static const neutralColor = Color(0xFFEDEDED); // Light Gray

  static const primary = Color(0xFF008000); // Dark Green
  ...
  static const analogous1Secondary = Color(0xFF2E313F);
  static const analogous2Secondary = Color(0xFF303341);
  static const darkerShade1Secondary = Color(0xFF1F212C);
  static const darkerShade2Secondary = Color(0xFF191B25);
